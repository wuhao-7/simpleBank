...
// TransferParams contains the input paramters of the transfer transaction
...
// It creats a transfer record, add account entries,and update accounts'balance within a single database transcation
